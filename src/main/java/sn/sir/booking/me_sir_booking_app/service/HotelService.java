...
import sn.sir.booking.me_sir_booking_app.model.HotelDTO;
...
public class HotelService {
    ...
    private HotelDTO mapToDTO(final Hotel hotel, final HotelDTO hotelDTO) {
        ...
        hotelDTO.setDateCreated(hotel.getDateCreated());
        hotelDTO.setLastUpdated(hotel.getLastUpdated());
        return hotelDTO;
    }
    ...
    private Hotel mapToEntity(final HotelDTO hotelDTO, final Hotel hotel) {
        ...
        hotel.setDateCreated(hotelDTO.getDateCreated());
        hotel.setLastUpdated(hotelDTO.getLastUpdated());
        return hotel;
    }
